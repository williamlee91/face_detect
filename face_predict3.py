...
class Camera_reader(object):
    ...
    def build_camera(self, camera_id, path_name):
        ...
        prefix = ['../execute_system/MTCNN_Tensorflow/data/MTCNN_model/PNet_landmark/PNet', 
                  '../execute_system/MTCNN_Tensorflow/data/MTCNN_model/RNet_landmark/RNet', 
                  '../execute_system/MTCNN_Tensorflow/data/MTCNN_model/ONet_landmark/ONet']
        
        #if you want to use new model, you should modify epochs
        #The first model of MTCNN, the parameters of epochs is [18,14,16]
        #The secomd model of MTCNN, the parameters of epochs is [30,22,22]
        #../MTCNN_Tensorflow/data/MTCNN_model/PNet_landmark/PNet-30
        #../MTCNN_Tensorflow/data/MTCNN_model/RNet_landmark/RNet-22
        #../MTCNN_Tensorflow/data/MTCNN_model/ONet_landmark/ONet-22
        epoch = [18, 14, 16]
