...
import numpy as np
#According to original paper,the author sorts the loss computed 
#in the forward propagation phase from all samples and selects 
#the top 70% of them as hard samples.That is called OHEM.
...
def P_Net(inputs,label=None,bbox_target=None,landmark_target=None,training=True):
    ...
    with slim.arg_scope([slim.conv2d],
        ...
        net = slim.conv2d(inputs,num_outputs=10,kernel_size=[3,3], stride=1,scope='conv1_1')
        print (net.get_shape())
        net = slim.conv2d(net,num_outputs=10,kernel_size=[2,2], stride=2, scope='conv1_2', padding='SAME')
        print (net.get_shape())
...
def R_Net(inputs,label=None,bbox_target=None,landmark_target=None,training=True):
    with slim.arg_scope([slim.conv2d],
                        ...
                        padding='valid'):
        print (inputs.get_shape())
        net = slim.conv2d(inputs, num_outputs=28, kernel_size=[3,3], stride=1, scope="conv1_1")
        print (net.get_shape())
        net = slim.conv2d(net,num_outputs=28,kernel_size=[3, 3], stride=2, scope="conv1_2", padding='SAME')
        print (net.get_shape())
        net = slim.conv2d(net,num_outputs=48,kernel_size=[3,3],stride=1,scope="conv2_1")
        print (net.get_shape())
        net = slim.conv2d(net,num_outputs=48,kernel_size=[3,3],stride=2,scope="conv2_2")
        print (net.get_shape())
...
def O_Net(inputs,label=None,bbox_target=None,landmark_target=None,training=True):
    with slim.arg_scope([slim.conv2d],
                        ...
                        padding='valid'):
        print (inputs.get_shape())
        net = slim.conv2d(inputs, num_outputs=32, kernel_size=[3,3], stride=1, scope="conv1_1")
        print (net.get_shape())
        net = slim.conv2d(net,num_outputs=32,kernel_size=[3,3],stride=2,scope="conv1_2", padding='SAME')
        print (net.get_shape())
        net = slim.conv2d(net,num_outputs=64,kernel_size=[3,3],stride=1,scope="conv2_1")
        print (net.get_shape())
        net = slim.conv2d(net,num_outputs=64,kernel_size=[3,3],stride=2,scope="conv2_2")
        print (net.get_shape())
        net = slim.conv2d(net,num_outputs=64,kernel_size=[3,3],stride=1,scope="conv3_1")
        print (net.get_shape())
        net = slim.conv2d(net,num_outputs=64,kernel_size=[2,2],stride=2, scope="conv3_2", padding='SAME')
        print (net.get_shape())
