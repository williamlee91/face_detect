...
#                print('op{}:'.format(i),m.values())
            ...
            self.inputs= self.sess.graph.get_tensor_by_name("img_inputs:0")  
            print("input_X:",self.inputs)
            self.out = self.sess.graph.get_tensor_by_name("embeddings:0")  
...
if __name__ == '__main__':
    path = r'E:/sign_system/execute_system/haar_extract/simplefacenet_new9_4.pb'   
    hmodel = Face(path)
    
    #hmodel.crop_pic_extract()
    
    camera_id = 0
    path_name = r'E:/sign_system/execute_system/crop_feature/test9_4.txt'
